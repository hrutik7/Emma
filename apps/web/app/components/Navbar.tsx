...
export default function Navbar() {
  ...
  <nav className="flex flex-col justify-center items-center sm:flex-row  max-w-[85rem] w-full mx-auto  px-4 sm:flex sm:items-center sm:justify-between" aria-label="Global">
    ...
    <div className='flex cursor-pointer align-middle justify-center rounded-xl h-12 p-1 w-[9rem] bg-[#2563eb]'>
      <p className='flex text-bold font-bold font-poppins tracking-wide items-center text-lg text-white justify-center'>Get started</p>
    </div>
    </div>
  </nav>
</header>
